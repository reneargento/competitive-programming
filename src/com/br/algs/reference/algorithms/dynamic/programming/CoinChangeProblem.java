...
public class CoinChangeProblem {
    ...
    public static void main(String[] args) {
        ...
        long coinChangePossibilities1 = calculateCoinChangePossibilities2(coins1, targetExchange1);
        long coinChangePossibilities2 = calculateCoinChangePossibilities2(coins2, targetExchange2);
    ...
    // Based on http://www.geeksforgeeks.org/dynamic-programming-set-7-coin-change/
