...
public class RabinKarp2D {
    ...
    public static void main(String[] args) {
        ...
        RabinKarp2D rabinKarp2D6 = new RabinKarp2D(pattern1);
        int[] result6 = rabinKarp2D6.search(text6);
        System.out.println("Result 6: " + result6[0] + ", " + result6[1] + " Expected: -1, -1");


        RabinKarp2D rabinKarp2D7 = new RabinKarp2D(pattern2);
        int[] result7 = rabinKarp2D7.search(text6);
        System.out.println("Result 7: " + result7[0] + ", " + result7[1] + " Expected: 1, 1");
        ...
        // Pattern == text
        RabinKarp2D rabinKarp2D10 = new RabinKarp2D(text6);
