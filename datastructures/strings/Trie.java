...
public class Trie<Value> {
    ...
    public Iterable<String> keysWithPrefix(String prefix) {
        ...
        LinkedList<String> keysWithPrefix = new LinkedList<>();
    ...
    private void collect(Node node, StringBuilder prefix, LinkedList<String> queue) {
        if (node == null) {
            return;
        }
    ...
    private void collect(Node node, StringBuilder prefix, String pattern, LinkedList<String> queue) {
        if (node == null) {
            return;
        }
